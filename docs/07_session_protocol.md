...
| 2026-08-23 | `docs/mockups/home_20260823_full.html` | トップページ全体 | **トップ全体構成の正。** 完成形のHTML。ユーザー指示は「ふんだんに盛り込む」= レイアウト・文言・構成を再現し、色は既存トークンに載せ替える。読み取り結果の要約は `home_20260823_cta_banners.md` §1〜§2 |
