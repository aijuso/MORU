...
> 最終更新: **2026-08-28**(MORU500 全顧客開放・全商品+¥500・フロント刷新一式を**本番反映済み** D-155〜162。**Dev と live は一致**。ローンチ阻害ゼロ。**統合割引の「注文割引」チェックも Owner 実施済み = MORU500 は他割引と併用可**。**商品説明→特徴の統合を ACTIVE 28全件で完了 D-163**)
